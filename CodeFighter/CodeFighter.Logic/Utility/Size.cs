...
namespace CodeFighter.Logic.Utility
{
    public struct Size
    {
        ...
        /// <devdoc>
        ///    <para>
        ///       Contracts a <see cref='CodeFighter.Logic.Utility.Size'/> by another <see cref='CodeFighter.Logic.Utility.Size'/>
        ///       .
        ///    </para>
        /// </devdoc>
        public static Size operator -(Size sz1, Size sz2)
        ...
        /// <include file='doc\Size.uex' path='docs/doc[@for="Size.operator=="]/*' />
        /// <devdoc>
        ///    Tests whether two <see cref='CodeFighter.Logic.Utility.Size'/> objects
        ///    are identical.
        /// </devdoc>
        ...
        /// <devdoc>
        ///    <para>
        ///       Tests whether two <see cref='CodeFighter.Logic.Utility.Size'/> objects are different.
        ///    </para>
        /// </devdoc>
        public static bool operator !=(Size sz1, Size sz2)
        {
